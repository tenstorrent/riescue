...
"""
    ...
    def failed(self) -> str:
        ...
        code = ""
        # Print RVCP FAIL message if enabled (only for discrete tests, not setup/cleanup)
        if self.featmgr.print_rvcp_failed:
            code += """
