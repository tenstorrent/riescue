...
class Page:
    ...
    def __init__(
        ...
        self.attrs: dict[str, Optional[int]] = {
            ...
            "n_level3": 0,
            "n_level4": 0,
            "n_level4_glevel0": None,
            "n_level4_glevel1": None,
            "n_level4_glevel2": None,
            "n_level4_glevel3": None,
            "n_level4_glevel4": None,
            "n_level3_glevel0": None,
            "n_level3_glevel1": None,
            "n_level3_glevel2": None,
            "n_level3_glevel3": None,
            "n_level3_glevel4": None,
            "n_level2_glevel0": None,
            "n_level2_glevel1": None,
            "n_level2_glevel2": None,
            "n_level2_glevel3": None,
            "n_level2_glevel4": None,
            "n_level1_glevel0": None,
            "n_level1_glevel1": None,
            "n_level1_glevel2": None,
            "n_level1_glevel3": None,
            "n_level1_glevel4": None,
            "n_level0_glevel0": None,
            "n_level0_glevel1": None,
            "n_level0_glevel2": None,
            "n_level0_glevel3": None,
            "n_level0_glevel4": None,
            "secure": 0,
            "gstage_n": 0,
            "modify_pt": 0,
            "gstage_modify_pt": 0,
...
class PageMap:
    ...
    def create_sptbr(self) -> None:
        ...
        phys_addr_c = addrgen.AddressConstraint(
            ...
            # When XLEN == 64, satp has a 44 bit PPN field, so physical address is 56 bits
            # In bare environement, we can use full 56 bits, but in virtualized
            # environment, we need to limit to the guest physical address space
            # width
            bits=56 if self.featmgr.env == RV.RiscvTestEnv.TEST_ENV_BARE_METAL else RV.RiscvPagingModes.linear_addr_bits(self.featmgr.paging_g_mode, gstage=True),
            mask=phys_mask,
            size=size,
        )
