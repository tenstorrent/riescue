...
MAX_NODES = 1000
    ...
    # Call union function to merge nodes 2 and 3
    li a0, 2
    li a1, 3
    jal union

    # Call find function to get parent of node 2
    li a0, 2
    jal find
    mv t0, a0
    # t0 now contains the parent index of node 2

    # Call find function to get parent of node 3
    li a0, 3
    jal find
    mv t1, a0
    # t1 now contains the parent index of node 3

    # Check that nodes 2 and 3 have been merged
    beq t0, t1, merged
    j not_merged

merged:
    # Nodes 2 and 3 have been merged
    # Continue with program...
    j exit
not_merged:
    # Nodes 2 and 3 have not been merged
    # Continue with program...
    j exit
...
# Function to initialize nodes and parents
initialize:
    li a0, 0
    li a1, MAX_NODES
    li t0, data
