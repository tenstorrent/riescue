...
;#page_mapping(lin_name=lin1, phys_name=phys1, v=1, r=1, w=1, pagesize=['4kb', '2mb', '1gb', '512gb', '256tb', 'any'], gstage_vs_leaf_pagesize=['2mb'])
...
# ;#page_mapping(lin_name=lin1_io, phys_name=phys1_io, v=1, r=1, w=1, pagesize=['4kb'], gstage_vs_leaf_pagesize=['4kb'])
;#page_mapping(lin_name=lin1_io, phys_name=phys1_io, v=1, r=1, w=1, pagesize=['4kb'])
...
# ;#page_mapping(lin_name=lin2, phys_name=&random, v=1, r=1, w=1, x=1, pagesize=['4kb'], page_maps=['map1', 'map2', 'map3'])
; #page_mapping(lin_name=lin2, phys_name=&random, v=1, r=1, w=1, x=1, pagesize=['4kb'])
...
;#page_mapping(lin_name=lin7, phys_name=phys7, v=1, r=1, w=1, x=1, pagesize=['4kb'], gstage_vs_leaf_pagesize=['4kb'])
;#page_mapping(lin_name=lin7+0x1000, phys_name=phys7+0x1000, v=1, r=1, w=1, x=1, pagesize=['4kb'], gstage_vs_leaf_pagesize=['4kb'])
...
;#page_mapping(lin_name=lin3, phys_name=&random, v=1, r=1, w=1, pagesize=['1gb'], gstage_vs_nonleaf_pagesize=['1gb'])
...
;#page_mapping(lin_name=lin4, phys_name=&random, v=1, r=1, w=1, pagesize=['4kb'], gstage_vs_leaf_pagesize=['1gb'])
...
;#page_mapping(lin_name=lin5, phys_name=&random, v=1, r=1, w=1, g_nonleaf=0, pagesize=['1gb'])
;# ;#page_mapping(lin_name=lin5, phys_name=&random, v=1, r=1, w=1, g_nonleaf=0, pagesize=['256tb'])
...
;#page_mapping(lin_name=lin6, phys_name=&random, v=1, r=1, w=1, d=1)
...
;#page_mapping(lin_name=lin6_a, phys_name=phys6_a, v=1, r=1, w=1, a_nonleaf_gleaf=0)
...
;#page_mapping(lin_name=lin6_d, phys_name=phys6_d, v=1, r=1, w=1)
...
;#page_mapping(lin_name=lin6_d_g, phys_name=phys6_d_g, v=1, r=1, w=1, d_leaf_gleaf=0)
...
;#page_mapping(lin_name=lin8, phys_name=phys8, v=1, r=1, w=1, v_leaf_gnonleaf=0, pagesize=['4kb'])
...
;#page_mapping(lin_name=lin8_a, phys_name=phys8_a, v=1, r=1, w=1, v_nonleaf_gnonleaf=0, pagesize=['4kb'])
...
;#page_mapping(lin_name=lin9, phys_name=phys9, v=1, r=1, w=1, g_nonleaf_gnonleaf=1)
...
;#page_mapping(lin_name=lin9_a, phys_name=phys9_a, v=1, r=1, w=1, a_leaf_gleaf=0)
...
;#page_mapping(lin_name=lin9_b, phys_name=phys9_b, v=1, r=1, w=1, x_nonleaf=1)
...
# ;#page_mapping(lin_name=lin6, phys_name=phys6, v=1, r=1, w=1, pagesize=['2mb'])
# ;#page_mapping(lin_name=lin6+0x201000, phys_name=phys6+0x201000, v=1, r=1, w=1, pagesize=['4kb'])
# ;#page_mapping(lin_name=lin6+0x202000, phys_name=phys6+0x201000, v=1, r=1, w=1, pagesize=['4kb'])
# ;#page_mapping(lin_name=lin6+0x203000, phys_name=phys6+0x201000, v=0, r=1, w=1, pagesize=['4kb'])
# ;#page_mapping(lin_name=lin6+0x204000, phys_name=phys6+0x201000, v=0, r=1, w=1, pagesize=['4kb'])
# ;#page_mapping(lin_name=lin6+0x205000, phys_name=phys6+0x201000, v=1, r=1, w=1, pagesize=['4kb'])
...
#
# ;#page_ mapping(lin_addr=0x500000000, phys_addr=0x500000000, v=1, r=1, w=1, x=1, pagesize=['4kb'])
# ;#page_ mapping(lin_addr=0x600000000, phys_name=&random, v=1, r=1, w=1, x=1, pagesize=['4kb'], modify_pt=1)
...
;#page_mapping(lin_name=my_code_page, phys_name=&random, v=1, u=1, x=1, r=1, w=1, pagesize=['4kb'])
