...
;#test.paging_g   sv39 sv48 sv57 disable any
;#test.category   arch
;#test.class      vector
...
;#page_mapping(lin_name=lin9, phys_name=phys9, v=1, r=1, w=1, a=1, d=1, v_leaf_gleaf=0)
...
;#page_mapping(lin_name=lin9_a, phys_name=phys9_a, v=1, r=1, w=1, a=1, d=1, v_nonleaf_gleaf=0)

# Consecutive pages may have a couple of bugs to iron out with virtualization
