...
class LoadAction(Action):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.constraints = {"category": Category.LOAD, "exclude_extensions": Extension.A | Extension.SVINVAL}
        self.expanded = False
    ...
    def pick_instruction(self, ctx: LoweringContext) -> Instruction:
        ...
        constraints: dict[str, Any] = {"category": Category.LOAD, "exclude_extensions": Extension.A | Extension.SVINVAL}
        if self.offset:
