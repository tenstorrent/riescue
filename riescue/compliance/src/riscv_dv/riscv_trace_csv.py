...
import csv
from riescue.compliance.src.riscv_dv.lib import sint_to_hex
...
class RiscvInstructionTraceEntry(object):
    ...
    def get_trace_string(self):
        ...
        return "pc[{}] {}: {} {} {} {}".format(self.pc, self.instr_str, " ".join(self.gpr), " ".join(self.csr), " ".join(self.pa), " ".join(self.stdata))
...
class RiscvInstructionTraceCsv(object):
    ...
    def start_new_trace(self):
        ...
        fields = ["pc", "instr", "gpr", "csr", "pa", "stdata", "binary", "mode", "instr_str", "operand", "pad"]
    ...
    def read_trace(self, trace):
        ...
        for row in csv_reader:
            ...
            new_trace.pc = row["pc"]
            new_trace.pa = row["pa"].split(";")
            new_trace.stdata = row["stdata"].split(";")
