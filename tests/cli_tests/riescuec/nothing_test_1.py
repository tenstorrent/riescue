...
class Nothing1(unittest.TestCase):
    ...
    def test_0(self):
        args = "--json compliance/tests/special/nothing.json --first_pass_iss whisper --groups vector_sha2_secure_hash --rpt_cnt 1 --max_instrs 1000 --seed 0"
    ...
    def test_5(self):
        args = "--json compliance/tests/special/nothing.json --first_pass_iss whisper --groups zvkg --rpt_cnt 1 --max_instrs 1000 --seed 0"
        RiescueC.run_cli(args=args.split())

    def test_6(self):
        args = "--json compliance/tests/special/nothing.json --first_pass_iss whisper --groups zvbb --rpt_cnt 1 --max_instrs 1000 --seed 0"
        RiescueC.run_cli(args=args.split())
    ...
    def test_14(self):
        args = "--json compliance/tests/special/nothing.json --first_pass_iss whisper --groups zvbc --rpt_cnt 1 --max_instrs 1000 --seed 0"
        RiescueC.run_cli(args=args.split())
